...
def parse_json_to_text(input_dir: Path, output_dir: Path, encoding: str = 'utf-8-sig'):
    ...
    for json_file in input_dir.glob('*.json'):
        ...
        cleaned_headings = [heading.strip() for heading in headings if heading.strip()]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', type=Path, default="/workspaces/guidescanner/data/scraped_websites/spiderman", help="Directory containing JSON files.")
    parser.add_argument('--output_dir', type=Path, default="/workspaces/guidescanner/src/app/graphrag_data/spiderman/input", help="Directory to save the output text files.")
