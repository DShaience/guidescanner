...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', type=Path, default="/workspaces/guidescanner/data/scraped_websites/bg3_ign_v2", help="Directory containing JSON files.")
    parser.add_argument('--output_dir', type=Path, default="/workspaces/guidescanner/graphrag_tests/full_bg3_v2/input", help="Directory to save the output text files.")
